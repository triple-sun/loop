...
export const notifyPropsSchema = z.object({
	...
	loop_mobile_push_reactions_sound: z
		.union([z.literal("true"), z.literal("false")])
		.optional(),
	loop_push_reactions: userNotifySchema.optional(),
	loop_push_reactions_sound: z
		.union([z.literal("true"), z.literal("false")])
		.optional(),
...
export const userProfileSchema = z.object({
	...
	last_password_update: z
		.number()
		.optional()
		.describe("Last password update timestamp"),
	last_picture_update: z
		.number()
		.optional()
