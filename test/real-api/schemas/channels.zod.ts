...
import {
	ChannelBookmarkType,
	ChannelCategorySorting,
	ChannelCategoryType,
	ChannelNotify,
	ChannelNotifyDesktopSound,
	ChannelType
} from "./channels";
...
export const channelNotifyDesktopSoundSchema = z.enum(
	ChannelNotifyDesktopSound
);
...
export const channelBookmarkCreateSchema = channelBookmarkCreateBaseSchema.and(
	z.union([channelBookmarkCreateLinkSchema, channelBookmarkCreateFileSchema])
);
...
export const channelMemberCountsByGroupSchema = z.record(
	z.string(),
	channelMemberCountByGroupSchema
);
...
export const channelNotifyPropsResponseSchema = z.object({
	...
	ignore_channel_mentions: z.union([
		z.literal("default"),
		z.literal("off"),
		z.literal("on")
	]),
