...
- **PostBuilder** - Создание и изменение постов с вложениями, действиями и полями ([подробный гайд](./docs/POST_BUILDER.ru.md))
- **FormBuilder** - Построение интерактивных форм ([подробный гайд](./docs/FORM_BUILDER.ru.md))
- **DialogBuilder** - Создание модальных диалогов ([подробный гайд](./docs/DIALOG_BUILDER.ru.md))
...
- [Репозиторий](https://github.com/foxford-backoffice/fox-loop-sdk)
- [Issues](https://github.com/foxford-backoffice/fox-loop-sdk/issues)
- [Документация Mattermost Interactive Messages](https://developers.mattermost.com/integrate/plugins/interactive-messages/)
