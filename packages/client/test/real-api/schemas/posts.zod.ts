...
import {
	type Post,
	type PostActionResponsePayload,
	PostActionStyle,
	PostActionType,
	PostAttachmentColor,
	type PostEmbed,
	...
	integration: z
		.object({
			url: z
				.string()
				.describe(
					"The actions are backed by an integration that handles HTTP POST requests when users select the message button.\nThe URL parameter determines where this action is sent. The request contains an application/json JSON string.\nAs of"
				),
			context: z
				.unknown()
				.optional()
...
export const postActionButtonSchema = postActionBaseSchema(
	buttonStyleSchema.shape
).extend({
...
const dataSourceSchema = z.any();

const optionsSchema = z.any();

export const postActionSelectSchema = postActionBaseSchema(dataSourceSchema)
...
export const postActionSchema = z.union([
	postActionButtonSchema,
	postActionSelectSchema
]);
...
export const postAttachmentSchema = z.object({
	...
	color: z
		.union([postAttachmentColorSchema, z.string()])
		.optional()
		.describe(
	...
	fields: z
		.array(postAttachmentFieldSchema)
		.optional()
		.nullable()
		.describe(
...
export const postMetadataSchema: z.ZodSchema<PostMetadata> = z.lazy(() =>
	z.object({
...
export const postEmbedSchema: z.ZodSchema<PostEmbed> = z.lazy(() =>
	z.object({
		type: postEmbedTypeSchema,
		url: z.string(),
		data: z
			.union([openGraphMetadataSchema, postPreviewMetadataSchema])
			.optional()
	})
);

export const postPreviewMetadataSchema: z.ZodSchema<PostPreviewMetadata> =
	z.lazy(() =>
		z.object({
			post_id: z.string(),
...
export const postActionResponsePayloadSchema: z.ZodSchema<PostActionResponsePayload> =
	z.lazy(() =>
		z.object({
