 ...
 * @see {@link https://developers.mattermost.com/integrate/reference/message-attachments/ | Message attachments}
 */
export interface PostActionButton extends PostActionBase, ButtonStyle {
 ...
 * @see {@link https://developers.mattermost.com/integrate/reference/message-attachments/ | Message attachments}
 */
export interface PostActionSelect extends PostActionBase, DataSource, Options {
    readonly type: PostActionType.SELECT;
}
export type PostAction = PostActionButton | PostActionSelect;
export interface PostActionData extends PostActionBase, Required<ButtonStyle>, Required<DataSource>, Required<Options> {
}
