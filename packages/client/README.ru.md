...
Современный, строго типизированный TypeScript клиент для [Loop](https://loop.ru). Совместим и с Node.js, и с браузерами, предоставляет (почти) полное покрытие Loop API с полной типобезопасностью.
