...
Современный, строго типизированный TypeScript клиент для [Loop](https://loop.ru) (форк Mattermost). Совместим с Node.js и браузерными окружениями, предоставляет (почти) полное покрытие Loop API с полной типобезопасностью.

## Возможности

✨ **Современный и типобезопасный**
- Написан на TypeScript 5.9 со строгой проверкой типов
- Полные определения типов для всех методов API

🔄 **Надёжный и устойчивый**
- Встроенные механизмы повторных попыток с настраиваемыми политиками
- Очередь запросов с контролем параллелизма (через [breadline-ts](https://github.com/triple-sun/breadline-ts))

🌐 **Совместимость**
- Совместим с Node.js (≥20) и браузерными окружениями
...
🧪 **Не менее обширное покрытие тестами**
...
loop-client/
├── src/
│   ├── web-client.ts       # Основной класс WebClient
...
ISC License - см. [package.json](package.json) для деталей

## Ссылки

- **Репозиторий**: [https://github.com/triple-sun/loop-client](https://github.com/triple-sun/loop-client)
- **Вопросы**: [https://github.com/triple-sun/loop-client/issues](https://github.com/triple-sun/loop-client/issues)
- **Документация Loop API**: [https://developers.loop.ru/API/4.0.0/loop-api-reference](https://developers.loop.ru/API/4.0.0/loop-api-reference)
- **Документация Mattermost API**: [https://developers.mattermost.com/api-documentation](https://developers.mattermost.com/api-documentation)

## Благодарности

- Вдохновлён [Slack Web API клиентом](https://github.com/slackapi/node-slack-sdk)
- Создан для совместимости с [Loop](https://loop.ru) и Mattermost APIs
- Использует [breadline-ts](https://github.com/triple-sun/breadline-ts) для очереди запросов
- Использует [again-ts](https://www.npmjs.com/package/again-ts) для логики повторов

---

**Сделано с ❤️ [triple-sun](https://github.com/triple-sun)**
